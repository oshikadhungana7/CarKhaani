...
def SendRequest_toOwner(request):
    ...
    RentVehicle_Date_of_Booking=request.POST.get('RentVehicle_Date_of_Booking','')
    # RentVehicle_Date_of_Booking = date = datetime.strptime(RentVehicle_Date_of_Return,  '%d/%m/%Y').date()
    # RentVehicle_Date_of_Return = datetime.strptime(RentVehicle_Date_of_Return, '%d/%m/%Y').date()

    RentVehicle_Date_of_Booking = date = datetime.strptime(RentVehicle_Date_of_Booking, "%B %d, %Y").date()
